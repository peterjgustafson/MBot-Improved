...
unsigned long modeForwardTime = 0;
void modeB()
{
  ...
  if (d > 15 || d == 0) {
    if(modeForwardTime == 0) {
      modeForwardTime = time;
      Forward();
    }
    else if (time - modeForwardTime > 7000) {
      switch (randNumber)
      {
        case 0:
          buzzer.tone(NTD7, 250); 
          delay(250);
          buzzer.tone(NTD1, 100); 
          delay(100);
          buzzer.tone(NTD4, 100); 
          delay(100);
          Backward();
          delay(1000);
          buzzer.tone(NTD7, 100); 
          delay(100);
          TurnLeft();
          delay(200);
          break;
        case 1:
          buzzer.tone(NTD1, 100); 
          delay(100);
          buzzer.tone(NTD2, 250); 
          delay(250);
          buzzer.tone(NTD3, 100); 
          delay(100);
          Backward();
          delay(500);
          buzzer.tone(NTD7, 100); 
  ...
  {
    buzzer.tone(NTDH7, 400); 
    Backward();
    delay(400);
    buzzer.tone(NTDH6, 400);
  }
  delay(100);
}
